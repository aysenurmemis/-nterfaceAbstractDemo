...
public class KPSPublicSoapProxy implements tr.gov.nvi.tckimlik.KPSPublicSoap {
  private String _endpoint = null;
  private tr.gov.nvi.tckimlik.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new tr.gov.nvi.tckimlik.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public tr.gov.nvi.tckimlik.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
