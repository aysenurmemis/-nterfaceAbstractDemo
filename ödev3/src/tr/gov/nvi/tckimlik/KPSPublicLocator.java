...
public class KPSPublicLocator extends org.apache.axis.client.Service implements tr.gov.nvi.tckimlik.KPSPublic {
    ...
    public tr.gov.nvi.tckimlik.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public tr.gov.nvi.tckimlik.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            tr.gov.nvi.tckimlik.KPSPublicSoapStub _stub = new tr.gov.nvi.tckimlik.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (tr.gov.nvi.tckimlik.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                tr.gov.nvi.tckimlik.KPSPublicSoapStub _stub = new tr.gov.nvi.tckimlik.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
